...
private[""_msg"",""_to""];
	...
	_msg = ctrlText 3003;
	_to = ""Adac Units"";
	if(_msg == """") exitWith {hint ""You must enter a message to send!"";ctrlShow[3030,true];};
...
case 0 :
{
	...
	hintSilent parseText format [""<t color='#FFCC00'><t size='2'><t align='center'>Neue Nachricht<br/><br/><t color='#33CC33'><t align='left'><t size='1'>Empfaenger: <t color='#ffffff'>Ich<br/><t color='#33CC33'>Von: <t color='#ffffff'>%1<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%2"",_from,_msg];
	player say3D ""alert"";
	systemChat _message;
};
...
case 1 :
{
	...
	hintSilent parseText format [""<t color='#316dff'><t size='2'><t align='center'>Neuer Notruf<br/><br/><t color='#33CC33'><t align='left'><t size='1'>Empfaenger: <t color='#ffffff'>Alle Polizisten<br/><t color='#33CC33'>Von: <t color='#ffffff'>%1<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%2"",_from,_msg];
	player say3D ""alert"";
	systemChat _message;
};
...
case 2 :
{
	...
	hintSilent parseText format [""<t color='#ffcefe'><t size='2'><t align='center'>Admin anfrage<br/><br/><t color='#33CC33'><t align='left'><t size='1'>Empfaenger: <t color='#ffffff'>Admins<br/><t color='#33CC33'>Von: <t color='#ffffff'>%1<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%2"",_from,_msg];
	player say3D ""alert""; 
	systemChat _message;
};
...
case 3 :
{
	...
	hintSilent parseText format [""<t color='#FF0000'><t size='2'><t align='center'>Admin Nachricht<br/><br/><t color='#33CC33'><t align='left'><t size='1'>Empfaenger: <t color='#ffffff'>Ich<br/><t color='#33CC33'>Von: <t color='#ffffff'>Admins<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%1"",_msg];
	player say3D ""alert"";
	systemChat _message;
...
case 4 :
{
	...
	_message = format[""!!!ADMIN Nachricht: %1"",_msg];
	_admin = format[""Gesendet von admin: %1"", _from];
	hintSilent parseText format [""<t color='#FF0000'><t size='2'><t align='center'>Admin Nachricht<br/><br/><t color='#33CC33'><t align='left'><t size='1'>Empfaenger: <t color='#ffffff'>Alle Spieler<br/><t color='#33CC33'>Von: <t color='#ffffff'>Admins<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%1"",_msg];
	player say3D ""alert""; 
	systemChat _message;
	if((call life_adminlevel) > 0) then {systemChat _admin;};
};
...
{
	private[""_message""];
	_message = format[""!!!SANI NOTRUF: %1"",_msg];
	hint parseText format [""<t color='#FFCC00'><t size='2'><t align='center'>Sani Notruf<br/><br/><t color='#33CC33'><t align='left'><t size='1'>Empfaenger: <t color='#ffffff'>Ich<br/><t color='#33CC33'>Von: <t color='#ffffff'>%1<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%2"",_from,_msg];
	[""TextMessage"",[format[""Sani Notruf von %1"",_from]]] call bis_fnc_showNotification;
	player say3D ""alert"";
	systemChat _message;
};
...
case 6: 
{
	...
	hint parseText format [""<t color='#FFCC00'><t size='2'><t align='center'>Adac Notruf<br/><br/><t color='#33CC33'><t align='left'><t size='1'>Empfaenger: <t color='#ffffff'>Ich<br/><t color='#33CC33'>Von: <t color='#ffffff'>%1<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%2"",_from,_msg];
	[""TextMessage"",[format[""Adac Notruf von %1"",_from]]] call bis_fnc_showNotification;
	player say3D ""alert"";
	systemChat _message;
};
};

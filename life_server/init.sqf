...
__CONST__(LIFE_SCHEMA_NAME,"'s603952'");//CHANGE THIS IF YOUR DATABASE IS NOT CALLED ARMA3LIFE KEEP THE ' '
...
life_radio_west = radioChannelCreate [[0, 0.95, 1, 0.8], "Seitenkanal", "%UNIT_NAME", []];
life_radio_civ = radioChannelCreate [[0, 0.95, 1, 0.8], "Seitenkanal", "%UNIT_NAME", []];
life_radio_indep = radioChannelCreate [[0, 0.95, 1, 0.8], "Seitenkanal", "%UNIT_NAME", []];
life_radio_east = radioChannelCreate [[0, 0.95, 1, 0.8], "Seitenkanal", "%UNIT_NAME", []];
...
[] spawn
{
	while {true} do
	{
		...
		} foreach [Dealer_1,Dealer_2,Dealer_3,Dealer_4];
	};
};
